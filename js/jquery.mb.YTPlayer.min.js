...
!function(jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        getDataFromAPI: function(a) {
            ...
            !a.isPlayer || a.opt.autoPlay || jQuery.browser.mobile || (a.loading = jQuery("<div/>").addClass("loading").html("Loading").hide(),
        ...
        playlist: function(a, b, c, d) {
            var e = this
              , f = e.get(0);
            return f.isPlayList = !0,
            b && (a = jQuery.shuffle(a)),
            f.videoID || (f.videos = a,
            f.videoCounter = 0,
        ...
        playNext: function(a) {
            var b = this.get(0);
            return b.checkForStartAt && (clearTimeout(b.checkForStartAt),
    ...
    jQuery.fn.optimizeDisplay = function(a) {
        ...
        b.opt.anchor = "undefined " != typeof b.opt.anchor ? b.opt.anchor : "center,center";
        ...
        if (b.opt.optimizeDisplay) {
            ...
            d.width = g.width,
            d.height = "16/9" == b.opt.ratio ? Math.ceil(d.width * (9 / 16)) : Math.ceil(.75 * d.width),
